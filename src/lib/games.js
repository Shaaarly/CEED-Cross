...
const GAME_SIMPLE_1 = {
  letters: 'abc',
  words: new Map([
    ['abc', { origin: [0, 0], direction: 'horizontal' }]
  ])
}
...
const GAME_SIMPLE_2 = {
  letters: 'abc',
  words: new Map([
    ['abc', { origin: [0, 0], direction: 'vertical' }]
  ])
}
...
const GAME_5 = {
  letters: 'petarypanltabn',
  words: new Map([
    ['pear', { origin: [4, 1], direction: 'horizontal' }],
    ['papaya', { origin: [6, 0], direction: 'vertical' }],
    ['patata', { origin: [1, 3], direction: 'horizontal' }],
    ['banana', { origin: [2, 2], direction: 'vertical' }],
    ['apple', { origin: [6, 5], direction: 'horizontal' }],
  ])
}
